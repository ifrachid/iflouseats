      ...
      >
        ...
        <div className={kcClsx("kcFormGroupClass")}>
          ...
          recaptchaAction !== undefined ? (
            <div id="kc-form-buttons" className="flex justify-center mb-4">
              <Button
                variant="ghost"
                className=" py-2 px-16 font-semibold bg-gray-300 rounded-md text-green-500"
                data-sitekey={recaptchaSiteKey}
                data-callback={() => {
                  (
            ...
            <div id="kc-form-buttons" className="flex justify-center">
              <Button
                disabled={
                  !isFormSubmittable ||
                  (termsAcceptanceRequired && !areTermsAccepted)
                }
                className=" py-2 px-16 mb-2 font-semibold bg-slate-950 disabled:bg-gray-600 text-white rounded-md"
                type="submit"
                variant="ghost"
              >
                {msgStr("doRegister")}
